    ...
    try {
        ...
        await pool.request()
           ...
           // .input('duration_value', sql.Float, data.duration_value)  // Old Input Value
            ...
            .input('limits_enabled.arc_time', sql.Bit, data.limits_enabled_arc_time)
            .input('limits_enabled.weld_score', sql.Bit, data.limits_enabled_weld_score)
            .input('limits_enabled.wire_feed_speed', sql.Bit, data.limits_enabled_wire_feed_speed)
            .input('limits_enabled.current', sql.Bit, data.limits_enabled_current)
            .input('limits_enabled.voltage', sql.Bit, data.limits_enabled_voltage)
